                ...
                <div className="m-auto">
                    ...
                    <div className="relative flex w-full flex-wrap items-stretch mb-3 mt-2">
                        <form onSubmit={handleSubmit}>
                            <input type="text" id="searchKey" name="searchKey" value={searchKey} placeholder="Search on Anveshaka" onChange={(e) => setSearchKey(e.target.value)} className="px-3 py-3 text-md placeholder-slate-600 relative bg-gray-200 text-black rounded-2xl border-0 outline-none focus:outline-none focus:ring w-128 pr-10 shadow-2xl focus:shadow-purple-800" />
