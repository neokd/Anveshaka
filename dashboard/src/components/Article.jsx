...
function Article() {
  ...
  return (
    <>
       <div className='bg-gradient-to-tl from-gray-700 via-gray-900 to-black min-h-screen pb-16'>
        <div className='container mx-auto lg:mx-24 pt-16'>
          <h1 className="text-white text-4xl font-bold mr-32">{article.title}</h1>
          <div className="flex flex-row flex-wrap my-12 text-white mr-32">
          ...
          <div>
            <p className='text-white/90 mr-32 text-lg pb-24 first-letter:text-3xl leading-relaxed'>
